...
@section('content')
    ...
    <div class="container mx-auto">
        ...
        <section id="newsletter" class="grid grid-cols-2 gap-2  my-8 p-2">
            <p class="text-4xl col-span-2 md:text-left border-l-4 border-blue-800 pl-2 text-blue-800">Join Our Newsletter
            </p>

            <div class="flex flex-col col-span-2 md:col-span-1 justify-center items-center   ">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-40 w-40 md:h-60 md:w-60 text-blue-700 stroke-current"
            ...
            <form class="flex flex-col justify-center col-span-2 md:col-span-1 md:mt-0 mt-4">
                ...
                <input type="text" placeholder="your name"
                    class="p-4  border focus:outline-white w-full text-gray-800" />
                <button
                    class="w-full p-4 bg-blue-700 mt-8 text-xl uppercase text-gray-50 hover:bg-blue-800 focus:outline-none"
            ...
            @foreach ($posts as $post)
                <div class="grid lg:grid-cols-2 border rounded-lg gap-4 h-auto p-4">
                    <div class="max-w-2xl  h-auto  flex items-center relative ">
                        <img src="{{ asset('upload/' . $post->image) }} " width="640" height="360"
                            class="w-full h-auto" alt="placeholder img" />
