        ...
        <section class="flex flex-col md:flex-row gap-4      p-4 w-full justify-center">
            <div
                ...
                <div class="flex gap-8  mt-8 mb-8 md:mb-0 items-start">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="-19.5036 -32.49725 169.0312 194.9835"
                        ...
                        <defs>
                            <radialGradient fy="578.088" fx="158.429"
                                ...
                                gradientUnits="userSpaceOnUse" r="65" cy="578.088" cx="158.429" id="c" />
                            <radialGradient fy="473.455" fx="147.694"
                                gradientTransform="matrix(.17394 .86872 -3.5818 .71718 1648.351 -458.493)"
                                gradientUnits="userSpaceOnUse" r="65" cy="473.455" cx="147.694" id="d" />
                            <linearGradient id="b">
            ...
            <div class="md:w-1/2 order-1">
                ...
                <form class="w-full">
                    <div class="w-full">
                        ...
                        <textarea placeholder="your message" cols="5" rows="6"
                            class="outline-none focus:outline-none border   text-xl   p-4 text-gray-800  w-full"></textarea>

                    </div>
                    <div class="w-full">
                        <label class="text-gray-600 font-medium md:my-2">Your Email</label>
                        <input type="email"
                            class="w-full  p-2 my-2 px-4 border focus:border-b-4  text-xl text-gray-800  focus:outline-none"
